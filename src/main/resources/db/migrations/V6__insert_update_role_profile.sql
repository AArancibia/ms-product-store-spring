...
values 
	('63c1e3f3-70a1-44d5-8c77-4b77c2e44cf3', '/shop', 'UngroupOutlined', '', false, 'Shop');
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre) 
values 
	('4f52eec9-6d83-41a6-bcf9-38bdca27eff7', '/cart', 'UngroupOutlined', '', false, 'Cart');
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre) 
values 
	('0c25a943-2f2c-49ea-ab29-edbc80df5c7a', '/portal', 'UngroupOutlined', '', false, 'Portal');

insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre) 
	values 
		('6d185037-82ef-4822-b352-9f1c28750c19', '/administration', 'UngroupOutlined', '', false, 'Administration');
		
insert into 
accesos 
	(id, ruta, icono, descripcion, general, nombre)
values 
	('48a4c547-1eb7-47a6-a714-ad98eae54dbf', '/inventory', 'UngroupOutlined', '', false, 'Inventory');
	
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre) 
values 
	('689f7231-748a-4035-aabc-74efa2533824', '/support', 'UngroupOutlined', '', false, 'Customer Support');
...
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('09794a5e-8431-4918-8781-4c2a8f03d5a8', '/portal/orders', 'UngroupOutlined', '', false, 'My orders');
	
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('bd0f78c4-c901-4e64-9322-1153d2df498f', '/portal/account', 'UngroupOutlined', '', false, 'My account');
	
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('d3f9eda6-1934-4e93-9df8-e0e5fd5a8004', '/portal/wishes', 'UngroupOutlined', '', false, 'My wishes');
...
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('6ae37124-3893-4cd3-b556-df33f44d7acd', '/administation/users', 'UngroupOutlined', '', false, 'Users');

insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('81178c4b-2fa8-4e69-bba9-b4b4afbcde64', '/administation/reports', 'UngroupOutlined', '', false, 'Reports');
...
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('14ff5dd7-f2db-441a-928e-66c1c720766f', '/inventory/products', 'UngroupOutlined', '', false, 'Products');

insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('bef2f556-043e-45d2-a5c9-f1d2f7f98b9e', '/inventory/providers','UngroupOutlined', '', false, 'Providers');
...
insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('fd886c5f-7db1-4b68-98a5-3030d6b59d62', '/support/inquires', 'UngroupOutlined', '', false, 'Inquires');

insert into 
	accesos 
		(id, ruta, icono, descripcion, general, nombre ) 
values 
	('1aeeea63-9004-4781-91d4-c38e43825528', '/support/claims', 'UngroupOutlined', '', false, 'Claims');
